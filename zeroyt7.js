...
botname = 'ZupBot' // GANTI NAMA BOT
denarakey = '𝔇𝔢𝔫𝔞𝔯𝔞'
ownername = 'ZupZup' // GANTI NAMA OWNER
...
switch (command) {
	...
	case 'help':
teks = `Hai ${pushname}
Saya ${botname} yang membantu mempermudahkan sesuatu seperti membuat stiker dan lainnya, butuh info dariku ?`
...
Note : Fitur Masih Dikit Karena Sedang Perkembangan
`
